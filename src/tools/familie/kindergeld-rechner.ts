...
// Stand 2026: Kindergeld einheitlich 255 € pro Kind und Monat (seit 01.01.2025).
const KINDERGELD_PRO_KIND = 255;
...
export const tool: Tool = {
  ...
  description:
    'Berechne das gesamte Kindergeld nach Anzahl der Kinder – monatlich und jährlich. Einheitlicher Betrag von 255 € pro Kind (Stand 2026).',
  keywords: [
    'kindergeld rechner',
    'kindergeld 2026',
    'kindergeld pro kind',
  ...
  intro:
    'Seit dem 1. Januar 2025 ist das Kindergeld einheitlich und beträgt 255 € pro Kind und Monat – unabhängig von der Reihenfolge der Kinder (Stand 2026). Dieser Rechner multipliziert den Betrag mit der Anzahl der Kinder und zeigt die monatliche und jährliche Summe. Den genauen aktuellen Betrag bestätigt die Familienkasse.',
  formula: 'Kindergeld gesamt = 255 € × Anzahl Kinder (pro Monat); Jahr = × 12',
  inputs: [
  ...
  howto: [
    ...
    'Monatliche Gesamtsumme ablesen (255 € je Kind).',
    'Jahresbetrag für die Haushaltsplanung übernehmen.',
    'Bei Studium oder Ausbildung Anspruch bis maximal 25 Jahre prüfen.',
  ],
  faq: [
    { q: 'Wie hoch ist das Kindergeld 2026?', a: 'Pro Kind 255 € im Monat. Der Betrag gilt seit dem 1. Januar 2025 einheitlich für alle Kinder, unabhängig von der Geschwisterreihenfolge (Stand 2026). Maßgeblich ist der aktuelle Bescheid der Familienkasse.' },
  ...
  examples: [
    {
      values: { kinder: 2 },
      expect: [
        { label: 'Kindergeld pro Monat', value: 510, tolerance: 0.01 },
        { label: 'Kindergeld pro Jahr', value: 6120, tolerance: 0.01 },
      ],
    },
    {
      values: { kinder: 3 },
      expect: [{ label: 'Kindergeld pro Monat', value: 765, tolerance: 0.01 }],
    },
  ],
  updated: '2026-06-18',
};
