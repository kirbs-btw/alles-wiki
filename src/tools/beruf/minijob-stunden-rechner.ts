...
export const tool: Tool = {
  ...
  inputs: [
    { type: 'number', id: 'stundenlohn', label: 'Stundenlohn (brutto)', unit: '€', default: 13.9, min: 0.01, step: 0.5, help: 'Mindestens der gesetzliche Mindestlohn (Stand 2026: 13,90 €/h).' },
    { type: 'number', id: 'grenze', label: 'Monatliche Verdienstgrenze', unit: '€', default: 603, min: 0, step: 1, help: 'Minijob-Grenze, Stand 2026: 603 €/Monat. Anpassbar, falls sie sich ändert.' },
  ...
  intro:
    'Im Minijob ist nicht die Stundenzahl, sondern der monatliche Verdienst gedeckelt. Wie viele Stunden du arbeiten darfst, hängt deshalb direkt von deinem Stundenlohn ab: Je höher der Lohn, desto weniger Stunden bis zur Grenze. Dieser Rechner zeigt deine maximalen Stunden und deinen aktuellen Verdienst. Stand 2026 liegt die Geringfügigkeitsgrenze bei 603 € pro Monat.',
  howto: [
  ...
  faq: [
    { q: 'Wie hoch ist die Minijob-Grenze 2026?', a: 'Stand 2026 beträgt die Geringfügigkeitsgrenze 603 € pro Monat. Sie ist an den Mindestlohn gekoppelt (Mindestlohn × 130 ÷ 3, aufgerundet) und kann sich künftig ändern – im Rechner anpassbar.' },
    { q: 'Warum hängen die Stunden vom Lohn ab?', a: 'Weil die Grenze in Euro definiert ist. Bei der Grenze von 603 € und einem Mindestlohn von 13,90 € ergeben sich rund 43 Arbeitsstunden im Monat.' },
    ...
    { q: 'Wird über das Jahr oder pro Monat gerechnet?', a: 'Die Grenze gilt im Monatsdurchschnitt; jährlich entspricht das dem Zwölffachen, also 7.236 € bei 603 €. Dieser Rechner betrachtet den einzelnen Monat.' },
  ],
  related: ['stundenlohn-rechner', 'teilzeit-gehalt-rechner', 'brutto-stundensatz-rechner'],
  updated: '2026-06-18',
  examples: [
    {
      values: { stundenlohn: 13.9, grenze: 603, stunden: 35 },
      expect: [
        { label: 'Maximale Stunden im Monat', value: 43.38, tolerance: 0.01 },
